...
# sits under a NOT_DOCS prefix. ci/ holds the harness notes for
# maintainers (ci/README.md, ci/COVERAGE.md) and is not documentation.
DOC_GLOBS = ("docs/**/*.md",)
NOT_DOCS = ()

# Pages outside the tree. None here: the package is a single
# implementation, and the generators' own output is not in this
# repository.
EXTRA_PAGES = ()

# Multi-port layout (one directory per language, each carrying its own
# pages). Off here: there is one TypeScript implementation.
PORT_DIRS = False
NOT_PORTS = ()
PORT_PAGES = ()
...
REQUIRED_PAGES = (
    ...
    "docs/how-to/add-an-environment.md",
    "docs/how-to/customise-templates.md",
    "docs/how-to/generate-the-web-app.md",
    "docs/reference/api.md",
    "docs/reference/envweb.md",
    "docs/tutorial.md",
)
REQUIRED_PORTS = ()
